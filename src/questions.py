questions = {
    ...
    '哪些行为有可能被禁言和封号？': '购买了VIP通行证，作为付费用户，违反网站规则。',
    '一亩三分地鼓励和提倡哪些发帖方式？': '读一下各个版块的置顶信息，了解网站规则。按规则发帖，与其他论坛用户高效交流',
    '在Linkedin上求内推如何作死?': '这些都会作死',
    '哪些人群在一亩三分地上不可能存在？': '这些都可能存在，并且尊重其他人文明发言的空间',
    '希望帖子被更多人看到、注意到，如何操作？': '这些都可以',
    '一亩三分地里可以购买VIP通行证，位于网站上方导航栏 -> VIP。关于VIP，下面哪些说法正确？': '以上都正确',
    '如果不希望大家继续讨论我发表的帖子，应该如何操作？': '帖子首楼右下角->”道具“中选择”关贴卡“，使用在自己发的主贴上。',
    '想找室友或者作为房东想找租客，帖子发在哪里？': '租房广告|找室友版',
    '在国内可以访问一亩三分地吗？': '可以',
    '为什么有人要讨论某个我觉得没用的问题？': '这些都包括，单个用户不能代表论坛全部用户',
    '违反论坛规则，被封号了怎么办？': '重新注册账号，这次认真遵守论坛规则，文明参与社区讨论',
    '是否可以在论坛发slack群、qq群、微信群等站外讨论方式？': '以上都正确',
    '以下关于 Troll 的说法，哪些正确？': '看见 troll 可以点击“thumb down" 表示反对，也可以点击“举报”',
    ...
    '谈判工资时，哪种做法有利于得到更大的包裹？': '精读工资谈判宝典：https://www.1point3acres.com/bbs/thread-286214-1-1.html 知己知彼，百战不殆',
    '一亩三分地里有哪些方面的干货信息？': '这些都有',
    '哪些行为可能被禁言和封号？': '这些都可能禁言封号',
    '下面哪些言论，在一亩三分地里算违规？': '这些以偏概全的说法都不推荐',
    '为什么讨论时不建议使用”凡尔赛“，”学渣“， ”一线土著“之类的标签？': '这些都包括',
    '如果希望匿名发帖，以下哪些说法正确？':'这些都正确',
    # 以下没有验证
    ...
    '留学申请选校时，哪种策略最合理？': '根据自己的职业目标，参考地里Offer多多的录取数据，找出自身特点和优势。',
    '如何对贴主表达支持？': '这些都可以',
    ...
    '关于加分的说法，哪些正确？': '不同版有不同的规则。干货内容上限会更高',
    '如果被引战，钓鱼，人身攻击，该怎么办？': '举报',
    '如果网暴他人，贴出别人隐私信息，以下哪些说法是正确的？': '会被删帖，扣分，情节严重的会被禁言、封号',
    '如果希望发布实习群，应该发在哪个版？': '入职圈',
    '如果希望使用论坛道具，关于兑换鳄梨，以下说法哪个最正确？': '以上都正确',
    '如果希望找飞友，应该发在哪个版': '学友飞友',
    '有的帖子感觉只适用于某些非主流群体，为什么我不能回帖说：“你不该在一亩三分地发这种帖子，没用的！”？': '以上这些都有道理。',
    '抖包袱版存在的目的是？': '让工资信息透明化，帮助有需求的人们更好的 negotiate 到最大的包',
    '按地区发帖和浏览有哪些好处？': '可以更好的获取周围地区的分类信息',
}
# 7.25 0
# 7.26 1
# 7.27 2
